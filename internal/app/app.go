...
func (a *App) Run() error {
	...
	codespaceConfig, err := a.flows.resolveCodespace.Resolve(inputs.ClientConfig, inputs.DefaultConfig, inputs.JsonConfig, inputs.DefaultConfig.Timezone, inputs.DefaultConfig.Image)
	if err != nil {
		return err
	}
